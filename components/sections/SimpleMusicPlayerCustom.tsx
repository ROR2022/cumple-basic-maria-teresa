...
interface SimpleMusicPlayerCustomProps {
    musicUrl: string;
}

const SimpleMusicPlayerCustom: FC<SimpleMusicPlayerCustomProps> = ({ musicUrl }) => {
    ...
    return (
        ...
        >
            ...
            {showWelcomePrompt && !hasUserInteracted && (
                <div 
                style={{display:'none'}}
                className="absolute bottom-full right-0 mb-4 animate-bounce z-10">
            ...
            {isPlaying && (
                <div 
                style={{display:'none'}}
                className="absolute -left-16 top-1/2 transform -translate-y-1/2 flex items-center space-x-1">
...
export default SimpleMusicPlayerCustom;